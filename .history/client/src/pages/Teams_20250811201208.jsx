                ...
                <Link 
                  ...
                  style={{
                    ...
                    boxShadow: hoveredTeam === index ? 
                      '0 25px 50px rgba(0,0,0,0.4), 0 0 30px rgba(255,255,255,0.1), inset 0 1px 0 rgba(255,255,255,0.1)' : 
                      '0 4px 20px rgba(0,0,0,0.2)',
                    borderColor: hoveredTeam === index ? 'rgba(255,255,255,0.3)' : 'rgba(255,255,255,0.08)',
                    backgroundImage: teamImage && hoveredTeam === index ? `url(${teamImage})` : 'none',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    backgroundRepeat: 'no-repeat',
                    background: hoveredTeam === index && !teamImage ? 
                      'linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(0,0,0,0.8) 50%, rgba(255,255,255,0.05) 100%)' :
                      styles.teamCard.background,
                  }}
