import missionBg from '../assests/mission.jpg';
...
export default function Mission() {
  ...
  const mission = {
    ...
    gradient: "linear-gradient(135deg, #ffffff 0%, #cccccc 50%, #666666 100%)"
  };
  ...
  const vision = {
    ...
    gradient: "linear-gradient(135deg, #000000 0%, #333333 50%, #999999 100%)"
  };
  ...
  const goals = {
    ...
    gradient: "linear-gradient(135deg, #666666 0%, #ffffff 50%, #333333 100%)"
  };
