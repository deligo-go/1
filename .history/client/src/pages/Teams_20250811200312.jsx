              ...
              return (
                <Link 
                  ...
                  style={{
                    ...
                    borderColor: hoveredTeam === index ? `${team.color}60` : 'rgba(255,255,255,0.1)',
                ...
                >
                  ...
                  <div style={{
                    ...styles.cardOverlay,
                    opacity: teamImage ? (hoveredTeam === index ? 0.3 : 0.6) : 0
                  }} />
                  ...
                  <div style={styles.cardContent}>
                    ...
                    <div style={styles.teamStats}>
                      ...
                      <div style={styles.teamStat}>
                        ...
                        <span style={styles.statLabel}>Specialties</span>
                      </div>
                    </div>

                    {/* Specialties */}
                    <div style={styles.specialtiesList}>
                      {team.specialties.slice(0, 4).map((specialty, idx) => (
                        <span key={idx} style={styles.specialty}>
                          {specialty}
                        </span>
                      ))}
                      {team.specialties.length > 4 && (
                        <span style={{...styles.specialty, opacity: 0.6}}>
                          +{team.specialties.length - 4} more
                        </span>
                      )}
                    </div>
                  </div>
