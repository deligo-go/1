              ...
              return (
                <Link 
                  ...
                  style={{
                    ...
                    background: hoveredTeam === index 
                      ? `linear-gradient(135deg, ${team.color}20 0%, rgba(255,255,255,0.05) 100%)` 
                ...
                >
                  ...
                  <div style={{
                    ...
                    right: 0,
                    bottom: 0,
                    background: `linear-gradient(135deg, ${team.color}10 0%, transparent 50%, ${team.color}05 100%)`,
                    opacity: hoveredTeam === index ? 1 : 0,
