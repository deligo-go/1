        ...
        <div className="container">
          <div style={styles.statsGrid}>
            <div style={styles.statCard}>
              <div style={styles.statCardNumber}>{overallStats.totalMembers}+</div>
              <div style={styles.statCardLabel}>Team Members</div>
            </div>
            <div style={styles.statCard}>
              <div style={styles.statCardNumber}>{overallStats.totalTeams}</div>
              <div style={styles.statCardLabel}>Specialized Teams</div>
            </div>
            <div style={styles.statCard}>
              <div style={styles.statCardNumber}>{overallStats.countries}</div>
              <div style={styles.statCardLabel}>Countries</div>
            </div>
            <div style={styles.statCard}>
              <div style={styles.statCardNumber}>{overallStats.experience}</div>
              <div style={styles.statCardLabel}>Avg. Experience (Years)</div>
            </div>
          </div>
        </div>
      </section>
