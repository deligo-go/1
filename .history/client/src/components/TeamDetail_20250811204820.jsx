          ...
          <div className="container">
            ...
            <div style={styles.membersGrid}>
              {team.members.map((member, index) => {
                // Create unique positioning for innovative layout
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      transform: hoveredMember === index 
                        ? `translateY(-12px) ${shouldOffset && isEven ? 'translateX(20px)' : shouldOffset && !isEven ? 'translateX(-20px)' : ''}`
                        : `translateY(${isEven && shouldOffset ? '40px' : !isEven && shouldOffset ? '-20px' : '0'})`,
                    }}
                  >
                    <div
                      style={{
                        ...styles.memberCard,
                        boxShadow: hoveredMember === index ? `0 25px 50px ${team.color}30` : '0 8px 30px rgba(0,0,0,0.2)',
                        borderColor: hoveredMember === index ? `${team.color}60` : 'rgba(255,255,255,0.1)',
