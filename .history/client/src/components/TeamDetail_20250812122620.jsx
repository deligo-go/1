                ...
                <div
                  ...
                  style={{
                    ...
                    ...(typeof member.avatar === 'string' && (member.avatar.includes('.jpg') || member.avatar.includes('.png') || member.avatar.includes('.jpeg')) ? {
                      ...
                      backgroundSize: (() => {
                        // Custom sizing for better face visibility - using contain for full person visibility
                        switch(member.name) {
                          // Cloud Team
                          ...
                          // VR Team
                          case 'Hrithik Ram .M': return 'contain'; // Show full person
                          case 'Gowtham V': return 'contain'; // Show full person
                          case 'Jaya Sudhan S': return 'contain'; // Show full person
                          // App Development Team
                          case 'Sarvesh': return 'cover';
                          case 'Sankar': return 'cover';
                          case 'Pradeep': return 'cover';
                          // FullStack Team
                          case 'Safil': return 'cover';
                          case 'Steffania': return 'cover';
                          case 'Nivetha': return 'cover';
                          // Media and Branding Team
                          case 'Susindiran G': return 'contain'; // Show full person
                          case 'Aditya K': return 'cover';
                          // Digital Marketing Team
                          case 'Jithender': return 'contain'; // Show full person
                      ...
                      backgroundPosition: (() => {
                        ...
                        switch(member.name) {
                          // Cloud Team
                          case 'Pranesh Kumar': return 'center 15%'; // Cloud Solutions Architect
                          case 'Chandrapriyan': return 'center 15%'; // DevOps Engineer
                          case 'Priya': return 'center 20%'; // Cloud Security Engineer
                          case 'Vibitha BK': return 'center 18%'; // Cloud Solutions Architect
                          case 'Prisha': return 'center 22%'; // Cloud Data Engineer
                          // VR Team
                          ...
                          // App Development Team
                          case 'Sarvesh': return 'center 15%'; // Senior Mobile App Developer
                          case 'Sankar': return 'center 15%'; // Full-Stack App Developer
                          case 'Pradeep': return 'center 20%'; // UI/UX App Designer & Developer
                          // FullStack Team
                          case 'Safil': return 'center 18%'; // Senior FullStack Developer
                          case 'Steffania': return 'center 18%'; // Full Stack Developer
                          case 'Nivetha': return 'center 20%'; // Full Stack Developer
                          // Media and Branding Team
                          case 'Susindiran G': return 'center 12%'; // Creative Director - face higher
                          case 'Aditya K': return 'center 15%'; // Media Designer
                          // Digital Marketing Team
