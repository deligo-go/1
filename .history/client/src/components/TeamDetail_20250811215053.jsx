                ...
                <div
                  ...
                  style={{
                    ...
                    ...(typeof member.avatar === 'string' && (member.avatar.includes('.jpg') || member.avatar.includes('.png') || member.avatar.includes('.jpeg')) ? {
                      ...
                      backgroundPosition: (() => {
                        // Custom positioning for each member based on their name
                        switch(member.name) {
                          case 'Pranesh Kumar': return 'center top';
                          case 'Priya': return 'center center';
                          case 'Vibitha BK': return 'center top';
                          case 'Prisha': return 'center center';
                          case 'Sankar': return 'center top';
                          case 'Pradeep': return 'center center';
                          case 'Steffania': return 'center center';
                          case 'Aditya K': return 'center top';
