...
export default function TeamDetail({ team }) {
  ...
  const styles = {
    ...
    memberAvatarImg: {
      ...
      background: 'linear-gradient(45deg, #6e4bc3, #a34b6e, #45b7d1) padding-box, linear-gradient(45deg, #6e4bc3, #a34b6e, #45b7d1) border-box',
      display: 'block',
      margin: '0 auto var(--spacing-md)',
      transition: 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
      filter: 'drop-shadow(0 8px 25px rgba(110, 75, 195, 0.3))',
      position: 'relative',
      zIndex: 2,
    },
    ...
    memberAvatarGlow: {
      ...
      bottom: '-5px',
      borderRadius: '50%',
      background: 'linear-gradient(45deg, #6e4bc3, #a34b6e, #45b7d1)',
      opacity: 0,
      filter: 'blur(15px)',
    ...
    memberAvatarFrame: {
      ...
      background: 'linear-gradient(45deg, #6e4bc3, #a34b6e, #45b7d1) border-box',
...
>
                  {typeof member.avatar === 'string' && (member.avatar.includes('.jpg') || member.avatar.includes('.png') || member.avatar.includes('.jpeg')) ? (
                    <div 
                      ...
                      onMouseEnter={(e) => {
                        const glow = e.currentTarget.querySelector('.avatar-glow');
                        const frame = e.currentTarget.querySelector('.avatar-frame');
                        ...
                        if (img) {
                          ...
                          img.style.filter = 'drop-shadow(0 12px 35px rgba(110, 75, 195, 0.5)) saturate(1.2)';
                        }
                      }}
                      onMouseLeave={(e) => {
                        const glow = e.currentTarget.querySelector('.avatar-glow');
                        ...
                        if (img) {
                          ...
                          img.style.filter = 'drop-shadow(0 8px 25px rgba(110, 75, 195, 0.3))';
                        }
                      }}
                    >
                      <div className="avatar-glow" style={styles.memberAvatarGlow}></div>
                      <div className="avatar-frame" style={styles.memberAvatarFrame}></div>
                      <img 
                        src={member.avatar} 
                        alt={member.name}
